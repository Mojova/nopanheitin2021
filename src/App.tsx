...
interface AppProps {
    rollDiceFn: (amount: number, successThreshold: number, doubleThreshold: number) => number[]
}
...
export const App: React.FC<AppProps> = (props) => {
    ...
    return (
        <div className="App">
            ...
            <ThresholdSelector threshold={successThreshold} min={4} name={'success'} onChange={setSuccessThreshold}>Onnistuminen</ThresholdSelector>
            <ThresholdSelector threshold={doubleThreshold} min={7} disableMin={successThreshold} name={'double'} onChange={setDoubleThreshold}>Tuplaraja</ThresholdSelector>
            <RollControls doRoll={doRoll} />
            <RollResultView rolls={roll} successThreshold={successThreshold} doubleThreshold={doubleThreshold} />
            <RollTable roll={roll} successThreshold={successThreshold} doubleThreshold={doubleThreshold} />
        </div>
    );
}
