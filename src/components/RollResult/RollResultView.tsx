...
export const RollResultView: React.FC<RollResultProps> = (props) => {
    ...
    const rollResult: RollResult = {
        ...
        successesWithoutDoubles: calculateSuccesses(rolls, successThreshold, Number.MAX_SAFE_INTEGER),
...
const calculateSuccesses = (rolls: number[], threshold: number, doubleLimit: number) => {
